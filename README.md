...
2a. Short version (for those experienced with setting up GRB)
2b. Long version (for first-timers)
3. Updating the Game Resource Bot
3a. on Microsoft Windows
3b. on MacOS
3c. on Linux
4. Changelogs
4a. GRB Setup Changelog
4b. GRB Update Changelog
...
2. Setting up the Game Resource Bot
2a. Setting Up the GameResourceBot - short version
    ==============================================
    ...
    *****ATTENTION*****
    ...
    This section is intended to be used as a quick reference only, usually by someone who's done this setup before.
    This section is a simple list of the steps required to set up the GameResourceBot, and nothing more.

    The long version of this guide gives complete explanations for every step in the process.
    If you are setting up this app for the first time, we strongly recommend using the long version (section 2b).
...
2b. Setting Up the GameResourceBot - long version
    =============================================
    v1.2, by PellaAndroid
    =====================
    ...
    *****SUPER-SPECIAL, SUPER-IMPORTANT NOTE*****
    	...
    	During this process, you WILL encounter technical terms, both within this document and without.
    	...
    	That's the bad news. Here's the good.
    		This document is here to help you. Do not be afraid.
    		If you see an unfamiliar term in this document, you can expect the next thing you read to explain that term.
    		This document is here to help you. Discard your fear.
    		If you see an unfamiliar term on a website, you can expect the relevant section of this document to explain that term.
    		This document is here to help you. Proceed with confidence.
    ...
    *****SUPER-SPECIAL, SUPER-IMPORTANT NOTE*****
    ...
    If you do not have the Manage Server permission on your Discord server, you have the following options:
    	...
    	If you chose option #2, stop reading and guide the individual you selected to this setup guide.
    ...
    Step 0(a): Tab #1 - Log in to GitHub.	https://www.github.com
    	...
    	Yes, we realise you are reading this guide on GitHub. That still doesn't mean you have an account here.
    ...
    Step 4: Heroku - Configure for automatic updates. Start the bot. Configure dynos.
    	...
    	And you will, very soon. But first, we have a bit of unfinished business to complete.
    		...
    		When that happens, you will need to update your GitHub repository with the new source code. [See separate document "GRB update".]
    ...
    ********** ********** ********** ********** ********** ********** ********** ********** **********
    ...
    Step 6: GitHub - Configure computer for source code updates.
    	...
    	Step 4 mentioned a separate document titled "GRB update". The instructions you need are in that document.
    	The "GRB update" document is available in three different flavours, for different operating systems.
    	You will find all three flavours in section 3 of this README file.
...
3. Updating the Game Resource Bot
3a. Updating the GameResourceBot (MS Windows)
=========================================
...
*****ATTENTION*****
	...
	If you previously completed all steps in this section and need to update again, skip to STEP 4.
...
If your computer's operating system is Microsoft Windows 7 or later (64-bit), this section is for you.


==========


This section assumes you are familiar with the document titled "Setting up the Game Resource Bot", meaning you have gone
through all the steps in that section and have a general understanding of all the technical terms in that
section. Otherwise, why would you even be reading this section? Therefore, if you encounter something
in this section that you do not understand and is not explained in this section, please refer to that section.
...
3b. Updating the GameResourceBot (MacOS)
    [content to be added later]

3c. Updating the GameResourceBot (Linux)
    [content to be added later]
