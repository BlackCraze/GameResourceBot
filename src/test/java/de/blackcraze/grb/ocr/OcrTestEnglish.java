...
public class OcrTestEnglish {
	...
	private static final String ALEXANDRITE = "ALEXANDRITE";
	private static final String ALUMINIUM = "ALUMINIUM";
	private static final String ALUMINIUM_BAR = "ALUMINIUM_BAR";
	private static final String ALUMINIUM_BOTTLE = "ALUMINIUM_BOTTLE";
	private static final String AMETHYST = "AMETHYST";
	private static final String BATTERY = "BATTERY";
	private static final String AMBER = "AMBER";
	private static final String AMBER_CHARGER = "AMBER_CHARGER";
	private static final String AMBER_BRACELET = "AMBER_BRACELET";
	private static final String AMBER_INSULATION = "AMBER_INSULATION";
	private static final String BOMB = "BOMB";
	private static final String DIAMOND = "DIAMOND";
	private static final String DIAMOND_CUTTER = "DIAMOND_CUTTER";
	private static final String DIETHYL_ETHER = "DIETHYL_ETHER";
	private static final String COPPER_WIRE = "COPPER_WIRE";
	private static final String IRON_BAR = "IRON_BAR";
	private static final String IRON = "IRON";
	private static final String ETHANOL = "ETHANOL";
	private static final String SOLID_PROPELLANT = "SOLID_PROPELLANT";
	private static final String GLASS = "GLASS";
	private static final String GOLD = "GOLD";
	private static final String GOLD_BAR = "GOLD_BAR";
	private static final String GRAPHITE = "GRAPHITE";
	private static final String GREEN_LASER = "GREEN_LASER";
	private static final String RUBBER = "RUBBER";
	private static final String HAIR_COMB = "HAIR_COMB";
	private static final String TREE = "WOOD";
	private static final String TREE_SEED = "SEED";
	private static final String INSULATED_WIRE = "INSULATED_WIRE";
	private static final String COAL = "COAL";
	private static final String COPPER = "COPPER";
	private static final String COPPER_BAR = "COPPER_BAR";
	private static final String COPPER_NAIL = "COPPER_NAIL";
	private static final String GLASS_FLASK = "GLASS_FLASK";
	private static final String LAMP = "LAMP";
	private static final String LIANA = "LIANA";
	private static final String LIANA_SEED = "LIANA_SEED";
	...
	private static final String POLISHED_ALEXANDRITE = "POLISHED_ALEXANDRITE";
	private static final String POLISHED_AMETHYST = "POLISHED_AMETHYST";
	private static final String POLISHED_AMBER = "POLISHED_AMBER";
	private static final String POLISHED_DIAMOND = "POLISHED_DIAMOND";
	private static final String POLISHED_RUBY = "POLISHED_RUBY";
	private static final String POLISHED_SAPPHIRE = "POLISHED_SAPPHIRE";
	private static final String POLISHED_EMERALD = "POLISHED_EMERALD";
	private static final String POLISHED_TOPAZ = "POLISHED_TOPAZ";
	private static final String REFINED_OIL = "REFINED_OIL";
	private static final String RUBY = "RUBY";
	private static final String SAPPHIRE = "SAPPHIRE";
	private static final String CLEAN_WATER = "CLEAN_WATER";
	private static final String OXYGEN = "OXYGEN";
	private static final String CIRCUIT = "CIRCUIT";
	private static final String GUNPOWDER = "GUNPOWDER";
	private static final String SULFUR = "SULPHUR";
	private static final String SULFURIC_ACID = "SULPHURIC_ACID";
	private static final String SILVER = "SILVER";
	private static final String SILVER_BAR = "SILVER_BAR";
	private static final String SILICON = "SILICON";
	private static final String EMERALD = "EMERALD";
	private static final String EMERALD_RING = "EMERALD_RING";
	private static final String SOLAR_PANEL = "SOLAR_PANEL";
	private static final String STEEL_BAR = "STEEL_BAR";
	private static final String STEEL_PLATE = "STEEL_PLATE";
	private static final String TITANIUM = "TITANIUM";
	private static final String TITANIUM_BAR = "TITANIUM_BAR";
	private static final String TITANIUM_ORE = "TITANIUM_ORE";
	private static final String TOPAZ = "TOPAZ";
	private static final String GRAPE = "GRAPE";
	private static final String GRAPE_SEED = "GRAPE_SEED";
	private static final String URANIUM = "URANIUM";
	private static final String URANIUM_ROD = "URANIUM_ROD";
	...
	private static final String POLISHED_OBSIDIAN = "POLISHED_OBSIDIAN";
	private static final String OBSIDIAN_KNIFE = "OBSIDIAN_KNIFE";
	private static final String COMPRESSOR = "COMPRESSOR";
	private static final String HELIUM_3 = "HELIUM_3";
	private static final String OBSIDIAN = "OBSIDIAN";
	private static final String LIQUID_NITROGEN = "LIQUID_NITROGEN";
	private static final String OPTIC_FIBER = "OPTIC_FIBER";
	...
	public void en_iphone7_750px_1334px_1710102230a() throws Exception {
		InputStream stream = OcrTestEnglish.class.getClassLoader().getResourceAsStream("en_iphone7_750px_1334px_1710102230a.png");
		Map<String, Long> stocks = OCR.convertToStocks(stream, Locale.ENGLISH);
		Assert.assertTrue(stocks.keySet().size() == 9);
	...
	public void en_iphone7_750px_1334px_1710102230b() throws Exception {
		InputStream stream = OcrTestEnglish.class.getClassLoader().getResourceAsStream("en_iphone7_750px_1334px_1710102230b.png");
		Map<String, Long> stocks = OCR.convertToStocks(stream, Locale.ENGLISH);
		Assert.assertTrue(stocks.keySet().size() == 9);
	...
	public void en_iphone7_750px_1334px_1710102230c() throws Exception {
		InputStream stream = OcrTestEnglish.class.getClassLoader().getResourceAsStream("en_iphone7_750px_1334px_1710102230c.png");
		Map<String, Long> stocks = OCR.convertToStocks(stream, Locale.ENGLISH);
		Assert.assertTrue(stocks.keySet().size() == 9);
		Assert.assertEquals(Long.valueOf(2136), stocks.get(SULFURIC_ACID));
		Assert.assertEquals(Long.valueOf(3961), stocks.get(RUBBER));
	...
	public void en_iphone7_750px_1334px_1710102230d() throws Exception {
		InputStream stream = OcrTestEnglish.class.getClassLoader().getResourceAsStream("en_iphone7_750px_1334px_1710102230d.png");
		Map<String, Long> stocks = OCR.convertToStocks(stream, Locale.ENGLISH);
		Assert.assertTrue(stocks.keySet().size() == 9);
		Assert.assertEquals(Long.valueOf(75), stocks.get(SOLAR_PANEL));
	...
	public void en_iphone7s_1242px_2208px_1710111915() throws Exception {
		InputStream stream = OcrTestEnglish.class.getClassLoader().getResourceAsStream("en_iphone7s_1242px_2208px_1710111915.png");
		Map<String, Long> stocks = OCR.convertToStocks(stream, Locale.ENGLISH);
		Assert.assertTrue(stocks.keySet().size() == 9);
	...
	public void en_720x1280_20171011193815() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(61), stocks.get(ACCUMULATOR));
