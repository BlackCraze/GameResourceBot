...
public class OcrTestGerman {
    ...
    public void test_de_01() throws Exception {
        InputStream stream = OcrTestEnglish.class.getClassLoader().getResourceAsStream("1080_de_01.png");
        List<Mat> extract = Preprocessor.extract(stream);
        Map<String, Long> stocks = OCR.convertToStocks(extract, Locale.GERMAN);
        ...
        Assert.assertEquals(Long.valueOf(379), stocks.get("SULPHURIC_ACID"));
        Assert.assertEquals(Long.valueOf(58), stocks.get("RUBBER"));
    }

    @Test
    public void test_de_03() throws Exception {
        InputStream stream = OcrTestEnglish.class.getClassLoader().getResourceAsStream("720_de_03.png");
        List<Mat> extract = Preprocessor.extract(stream);
        Map<String, Long> stocks = OCR.convertToStocks(extract, Locale.GERMAN);
        Assert.assertTrue(stocks.keySet().size() == 9);
    ...
    public void test_screens_bc_01() throws Exception {
        ...
        Assert.assertEquals(Long.valueOf(235), stocks.get("SEED"));
    }
    ...
    public void test_screens_bc_03() throws Exception {
        ...
        Assert.assertEquals(Long.valueOf(6770), stocks.get("SULPHUR"));
    ...
    public void test_screens_bc_04() throws Exception {
        ...
        Assert.assertEquals(Long.valueOf(1791), stocks.get("WOOD"));
        ...
        // SILVER AND SILVER BAR IS NAMED EQUALLY IN THE GAME ATM - there is nothing we can do here
//        Assert.assertEquals(Long.valueOf(2489), stocks.get("SILVER_BAR")); //FIXME
        Assert.assertEquals(Long.valueOf(2489), stocks.get("SILVER")); //FIXME
    }
    ...
    public void test_screens_bc_06() throws Exception {
        ...
        Assert.assertEquals(Long.valueOf(54), stocks.get("SULPHURIC_ACID"));
